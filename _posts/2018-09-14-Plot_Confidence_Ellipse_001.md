...
In the meantime, the implementation in the mentioned [github-gist]({{ page.gist }}) has made it into the collection of examples on [matplotlib.org](https://matplotlib.org/stable/gallery/statistics/confidence_ellipse.html).
